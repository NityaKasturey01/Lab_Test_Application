...
public class PathologyBookings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_pathology_bookings, container, false);
        ...
        loadData();
        getActivity().setTitle("Test Bookings");
                        ...
                        try {
                            ...
                            for (int i=0; i<jsonArray.length(); i++)
                            {
                                ...
                                bookings = new Bookings(jObj.getString("testname"),
                                        ...
                                        jObj.getString("rp"),
                                        jObj.getString("rr"));
                                bookings.setDname(jObj.getString("dname"));
                                /*LocalDate currentDate = LocalDate.now(ZoneId.systemDefault());
                                Log.i("curr",currentDate.toString());
                                DateTimeFormatter df = DateTimeFormatter.ofPattern("yyyy-M-dd");
                                LocalDate recreatedLocalDate = LocalDate.parse(bookings.getStatus(),df);*/
