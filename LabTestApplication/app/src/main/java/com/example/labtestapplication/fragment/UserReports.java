...
public class UserReports extends Fragment implements MyReportsAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        searchViewReports = view.findViewById(R.id.searchUserReports);
        recyclerViewReports = view.findViewById(R.id.recylerViewUserReports);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i=0; i<jsonArray.length(); i++)
                            {
                                ...
                                if (jObj.getString("rr").equals("unchecked"))
                                {
